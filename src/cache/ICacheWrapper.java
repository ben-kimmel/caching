...
public interface ICacheWrapper {
	...
	/**
	 * Checks to see if the given block ID is contained in the internal cache
	 * representation. Differs from {@link #requestBlock(int)} in that it does
	 * not elicit side effects, such as calling on cache steps or generating a
	 * {@link LogEntry}.
	 * 
	 * @param blockID
	 *            The block ID to request from the cache
	...
	/**
	 * Provides the {@link ICacheInternal} implementation to be used as the
	 * internal representation of the cache. Must be provided before the
	 * ICacheWrapper is functional.
	 * 
	 * @param cache
	...
	/**
	 * Returns a list of all {@link LogEntry} generated by requests.
	 * 
	...
	/**
	 * Returns the name of the {@ICacheWrapper}.
	 * 
	 * @return The name of the ICacheWrapper
	 */
